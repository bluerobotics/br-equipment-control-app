...
#define STATUS_PREFIX_RECOVERY              "GANTRY_RECOVERY: "      ///< Prefix for watchdog recovery notifications.
 ...
 * Format: "GANTRY_EVENT: event_name [param1] [param2] ..."
 * @{
 */
...
/**
 * @enum Event
 * @brief Enumerates all possible events that can be sent by the Gantry.
