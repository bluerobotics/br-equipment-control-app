 ...
 */
typedef struct {
    const char*  main_state                    ; ///< Overall gantry system state
    const char*  x_state                       ; ///< Current operational state of X-axis
    const char*  y_state                       ; ///< Current operational state of Y-axis
    const char*  z_state                       ; ///< Current operational state of Z-axis
