/**
 * @file events.h
 * @brief Defines all event types that can be sent from the Pressurizer controller.
 * @details AUTO-GENERATED FILE - DO NOT EDIT MANUALLY
 * Generated from events.json on 2025-11-12 10:48:49
 * 
 * This header file defines all events sent FROM the Pressurizer device TO the host.
...
#define STATUS_PREFIX_RECOVERY              "PRESSURIZER_RECOVERY: "      ///< Prefix for watchdog recovery notifications.
 ...
 * Format: "PRESSURIZER_EVENT: event_name [param1] [param2] ..."
 * @{
 */
...
/**
 * @enum Event
 * @brief Enumerates all possible events that can be sent by the Pressurizer.
...
typedef enum {
    ...
    EVENT_SCRIPT_RUN,                                   ///< @see EVENT_STR_SCRIPT_RUN
    EVENT_SCRIPT_HOLD,                                   ///< @see EVENT_STR_SCRIPT_HOLD
    EVENT_SCRIPT_RESET                                    ///< @see EVENT_STR_SCRIPT_RESET
} Event;
