...
#define STATUS_PREFIX_RECOVERY              "FILLHEAD_RECOVERY: "      ///< Prefix for watchdog recovery notifications.
 ...
 * @{
 */
#define EVENT_PREFIX                        "FILLHEAD_EVENT: "         ///< Prefix for all event messages.
/** @} */
...
/**
 * @enum Event
 * @brief Enumerates all possible events that can be sent by the Fillhead.
