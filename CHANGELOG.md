...
- **Device pane default width**: On first launch (no saved width), device pane width is set to exactly match the measured status panel width; on subsequent launches, uses the saved width from last manual resize
